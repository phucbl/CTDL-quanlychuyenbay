...
int main (){ 
  ...
  do
  {
	...
	case 13: {	ChuyenBay cb2;
				...
				{
					//cb2=p->cb;
				if (CompareDateTimeToNow(p->cb.timebay)==0) 
					{strcpy(p->cb.trangthai,"3"); cout<<"Chuyen bay da hoan tat. Khong the dat ve."; getch(); break;
					}
				int k;
				do
				{
	...
	case 14: { 
				...
				if (p!=NULL) 
				{
					//cb2=p->cb;
				if (CompareDateTimeToNow(p->cb.timebay)==0) 
					{strcpy(p->cb.trangthai,"3"); cout<<"Chuyen bay da hoan tat. Khong the huy ve."; getch(); break;
					}	
				int k;
				do
				{
